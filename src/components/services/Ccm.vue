<template>
  <v-card subtitle="CCM (Claude Code Multiplexer)">
    <v-row>
      <v-col cols="12" sm="6">
        <v-text-field :label="$t('types.ccm.credentialPath')" hide-details v-model="data.credential_path"> </v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
        <v-text-field :label="$t('types.ccm.usagesPath')" hide-details v-model="data.usages_path"> </v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
