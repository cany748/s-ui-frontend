...
export default {
  ...
  computed: {
    ...
    optionDetour: {
      get(): boolean {
        return this.$props.dial.detour != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.detour = this.outTags[0] ?? "") : delete this.$props.dial.detour;
      },
    },
    optionBind: {
      get(): boolean {
        return this.$props.dial.bind_interface != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.bind_interface = "") : delete this.$props.dial.bind_interface;
      },
    },
    optionIPV4: {
      get(): boolean {
        return this.$props.dial.inet4_bind_address != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.inet4_bind_address = "") : delete this.$props.dial.inet4_bind_address;
      },
    },
    optionIPV6: {
      get(): boolean {
        return this.$props.dial.inet6_bind_address != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.inet6_bind_address = "") : delete this.$props.dial.inet6_bind_address;
      },
    },
    optionBindNoPort: {
      get(): boolean {
        return this.$props.dial.bind_address_no_port != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.bind_address_no_port = true) : delete this.$props.dial.bind_address_no_port;
      },
    },
    optionTcpKeepAlive: {
      get(): boolean {
        return (
          this.$props.dial.disable_tcp_keep_alive != undefined ||
    ...
    optionRM: {
      get(): boolean {
        return this.$props.dial.routing_mark != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.routing_mark = 0) : delete this.$props.dial.routing_mark;
      },
    },
    optionRA: {
      get(): boolean {
        return this.$props.dial.reuse_addr != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.reuse_addr = true) : delete this.$props.dial.reuse_addr;
      },
    },
    optionTCP: {
      get(): boolean {
        return this.$props.dial.tcp_fast_open != undefined && this.$props.dial.tcp_multi_path != undefined;
      },
      set(v: boolean) {
        if (v) {
    ...
    optionUDP: {
      get(): boolean {
        return this.$props.dial.udp_fragment != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.udp_fragment = true) : delete this.$props.dial.udp_fragment;
      },
    },
    optionCT: {
      get(): boolean {
        return this.$props.dial.connect_timeout != undefined;
      },
      set(v: boolean) {
        v ? (this.$props.dial.connect_timeout = "5s") : delete this.$props.dial.connect_timeout;
      },
    },
    optionDR: {
      get(): boolean {
        return this.$props.dial.domain_resolver != undefined;
      },
      set(v: boolean) {
        this.$props.dial.domain_resolver = v ? (this.dnsTags[0] ?? "") : undefined;
      },
    },
    dnsTags() {
      return Data().config.dns?.servers?.map((d: any) => d.tag) ?? [];
    },
  },
};
</script>
