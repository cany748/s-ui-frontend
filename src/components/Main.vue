        ...
        <v-col cols="auto">
          <v-dialog v-model="menu" :close-on-content-click="false" transition="scale-transition" max-width="800">
            <template v-slot:activator="{ props }">
              <v-btn v-bind="props" hide-details variant="tonal" elevation="3"
          ...
          <v-btn variant="tonal" hide-details style="margin-inline-start: 10px" elevation="3" @click="backupModal.visible = true"
            ...
            <v-card-text style="padding: 0 16px" align="center" justify="center">
              ...
              <template v-if="i == 'i-sys'">
                <v-row>
                  ...
                  <v-col cols="9">
                    <v-chip density="compact" color="blue"> v{{ tilesData.sys?.appVersion }} </v-chip>
                  </v-col>
                  <v-col cols="3">{{ $t("main.info.uptime") }}</v-col>
                  <v-col
                    cols="9"
                    v-tooltip:top="
                      $t('main.info.startupTime') + ': ' + new Date((tilesData.sys?.bootTime || 0) * 1000).toLocaleString(locale)
                    "
                  >
...
const menuItems = [
  {
    title: i18n.global.t("main.gauges"),
    value: [
  ...
  {
    title: i18n.global.t("main.charts"),
    value: [
  ...
  {
    title: i18n.global.t("main.infos"),
    value: [
