    ...
    <v-card class="rounded-lg">
      ...
      <v-card-text style="padding: 0 16px; overflow-y: scroll">
        <v-container style="padding: 0">
          ...
          <v-row>
            <v-col cols="12" sm="8">
              <v-combobox chips multiple v-model="bulkData.name" :items="patterns" :label="$t('client.name')" hide-details> </v-combobox>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" sm="8">
              <v-combobox chips multiple v-model="bulkData.desc" :items="patterns" :label="$t('client.desc')" hide-details> </v-combobox>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="12" sm="6" md="4">
          ...
          <v-row>
            <v-col cols="12" sm="6" md="4">
              <v-switch color="primary" v-model="bulkData.delayStart" :label="$t('client.delayStart')" hide-details> </v-switch>
            </v-col>
            <v-col cols="12" sm="6" md="4">
