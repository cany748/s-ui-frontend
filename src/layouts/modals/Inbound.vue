    ...
    <v-card class="rounded-lg" :loading="loading">
      ...
      <v-card-text style="padding: 0 16px; overflow-y: scroll">
        <v-container style="padding: 0" :hidden="loading">
          ...
          <v-tabs v-if="HasInData.includes(inbound.type)" v-model="side" density="compact" fixed-tabs align-tabs="center">
...
export default {
  ...
  data() {
    return {
      ...
      MuxAvailable: [InTypes.VLESS, InTypes.VMess, InTypes.Trojan, InTypes.Shadowsocks],
